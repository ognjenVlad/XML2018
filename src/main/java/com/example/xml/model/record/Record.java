...
// Generated on: 2019.09.07 at 02:29:44 PM CEST 
//
 ...
 *         &lt;element name="report_ids" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="prescription_ids" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="referral_ids" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class Record {
    ...
    @XmlElement(name = "prescription_ids")
    protected List<String> prescriptionIds;
    @XmlElement(name = "referral_ids")
    protected List<String> referralIds;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the prescriptionIds property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPrescriptionIds().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<String> getPrescriptionIds() {
        if (prescriptionIds == null) {
            prescriptionIds = new ArrayList<String>();
        }
        return this.prescriptionIds;
    }

    /**
     * Gets the value of the referralIds property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the referralIds property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getReferralIds().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<String> getReferralIds() {
        if (referralIds == null) {
            referralIds = new ArrayList<String>();
        }
